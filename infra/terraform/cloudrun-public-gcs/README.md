...
- Downloads use a **V4 signed URL** generated by the app (default TTL: 3600 seconds, configurable via `signed_url_ttl_secs`).
- Terraform sets `SITEBOOKIFY_ARTIFACT_BUCKET` and `SITEBOOKIFY_SIGNED_URL_TTL_SECS` on the Cloud Run service.
