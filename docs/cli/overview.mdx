...
- OpenAI settings (API):
  - `OPENAI_API_KEY` (required; or `SITEBOOKIFY_OPENAI_API_KEY`)
  - `SITEBOOKIFY_OPENAI_MODEL` (default: `gpt-5.2`)
  - `SITEBOOKIFY_OPENAI_REASONING_EFFORT` (default: `medium`; e.g. `minimal`, `low`, `medium`, `high`, `xhigh`)
